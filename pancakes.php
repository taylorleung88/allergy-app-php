...
<nav class="navbar navbar-expand-lg navbar-light Blue-background">
    ...
    <div class="container">
                 ...
                 <form method="POST">
                    ...
                    <?php
                        if(isset($_POST["fave"])) {
                            ...
                            $sql = "INSERT into favorites (userId, userEmail, recipe_id, recipe_name) VALUES ('" .$dbID. "','" .$user. "', '14' , 'Pancakes')";
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <img src="assets/pancakes.jpg" alt="Image of pancakes" class="img-fluid" />
            </div>
        </div>
